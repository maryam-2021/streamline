...
export const GoogleButton = () => (
  <Button
    ...
    onClick={googleLogin}
    className="w-full rounded-xl border-border hover:bg-secondary transition-colors"
  >
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-6">
      <div className="w-full max-w-md">
        <Link to="/" className="flex items-center gap-2 justify-center mb-10" data-testid="login-logo">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 lg:p-10 shadow-xl shadow-teal-900/5 dark:shadow-black/40">
          ...
          <p className="text-sm text-muted-foreground text-center mt-8">
            No account?{" "}
            <Link to="/register" data-testid="login-register-link" className="text-primary hover:underline">Create one</Link>
          </p>
        </div>
      </div>
    </div>
